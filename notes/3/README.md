...
## [Amazon EBS & Amazon EFS](EBS-EFS/README.md) - [AWS Doc](https://docs.aws.amazon.com/ebs/)
...
## [Amazon S3 (Simple Storage Service)](S3/README.md) - [AWS Doc](https://docs.aws.amazon.com/s3/)
...
## [Amazon RDS & Amazon Aurora](RDS-Aurora/README.md) - [AWS Doc](https://docs.aws.amazon.com/rds/)
...
## [Amazon DynamoDB & Amazon ElastiCache](DynamoDB-ElastiCache/README.md) - [AWS Doc](https://docs.aws.amazon.com/amazondynamodb/)
...
## [Amazon CloudFront & AWS Global Accelerator](CloudFront/README.md) - [AWS Doc](https://docs.aws.amazon.com/cloudfront/)
...
## [Amazon Kinesis](Kinesis/README.md) - [AWS Doc](https://docs.aws.amazon.com/kinesis/)
...
## [AWS Analytical Processing & Big Data](Analytics/README.md) - [AWS Doc](https://docs.aws.amazon.com/athena/)
