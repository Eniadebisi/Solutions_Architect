...
## [Amazon S3 Lifecycle Management](S3-Lifecycle/README.md) - [AWS Doc](https://docs.aws.amazon.com/s3/)
...
## [AWS Storage Migration & Hybrid Storage](Storage-Migration/README.md) - [AWS Doc](https://docs.aws.amazon.com/storagegateway/)
...
## [AWS Compute Purchasing & Optimization](Compute-Purchasing/README.md) - [AWS Doc](https://docs.aws.amazon.com/ec2/)
...
## [AWS Network Cost Management](Network-Cost/README.md) - [AWS Doc](https://docs.aws.amazon.com/vpc/)
...
## [AWS Cost Governance Tools](Cost-Governance/README.md) - [AWS Doc](https://docs.aws.amazon.com/cost-management/)
...
- [ ] Perform historical analysis on cross-account expenditures using AWS Cost Explorer and Cost and Usage Reports (CUR).
